...
public class CurrentFormHomeTable extends Table {
    ...
    protected CurrentFormHomeTable(Division division, SortedSet<String> teams) {
        super("Form Home Table", division, teams);
        for (String team : teams) {
            table.put(team, new CurrentFormHomeTableEntry(team));
