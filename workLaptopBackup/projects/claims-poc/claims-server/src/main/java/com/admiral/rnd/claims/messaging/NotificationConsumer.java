...
public class NotificationConsumer {
    ...
    public static long POLL_PERIOD_MS = 10000;
    public static Duration POLL_PERIOD = Duration.ofMillis(POLL_PERIOD_MS);
    ...
    /**
     * Creates a {@link ThreadPoolExecutor} with a given number of threads to consume the messages from
     * the broker.
     * 
    ...
    public void execute(int numberOfThreads) {
        ...
        while (true) {
            ConsumerRecords<String, String> records = consumer.poll(POLL_PERIOD);
